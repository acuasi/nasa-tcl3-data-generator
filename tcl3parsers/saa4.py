...
def generate(mi_file_name, saa4_ti_name, saa4_td_name, radar_file_name, outfile_name):
    ...
    saa4_data["horRangeAccuracy_ft"] = None # Not quantified, slant range resolution is 3.25 m
    saa4_data["verRangeAccuracy_ft"] = None # Not quantified, slant range resolution is 3.25 m
    saa4_data["slantRangeAccuracy_ft"] = 3.25 * M_TO_FT
    saa4_data["timeToTrack_sec"] = 1.000 # Up to to 1 second but varies and info not collected
    saa4_data["probabilityFalseAlarmPrct_nonDim"] = None # Confidence threshold; discuss with Kevin
    saa4_data["probabilityIntruderDetectionPrct_nonDim"] = None # Confidence threshold; discuss with Kevin
    saa4_data["targetTrackCapacity_nonDim"] = 20
    saa4_data["dataPacketRatio_nonDim"] = None # Discuss with Kevin
    saa4_data["transmissionDelay_sec"] = None # Discuss with Kevin
    saa4_data["numberOfLostTracks_nonDim"] = None # Mo to check with her team
    saa4_data["intruderRadarCrossSection_ft2"] = 10^(-20/10) * M_TO_FT # Ask Hemil about this; aircraft for that flight or theoretical
    saa4_data["txRadioFrequencyPower_w"] = 3.4 # Ask Hemil if they want EIRP or ERP?
